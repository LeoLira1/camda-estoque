...
.corridor{display:flex;align-items:center;justify-content:center;height:38px;
  ...
  text-transform:uppercase;padding:0 20px;gap:8px;}
.corridor::before,.corridor::after{content:'\\25B6';color:var(--blue);opacity:.4;font-size:7px;}
.corridor-icon{font-size:18px;line-height:1;pointer-events:none;}
...
function renderMap() {
  ...
  truck.className = 'corridor-icon'; truck.textContent = '🛻';
  cor.appendChild(truck);
  var forklift = document.createElement('span');
  forklift.className = 'corridor-icon'; forklift.textContent = '🏗️';
  cor.appendChild(forklift);
  wh.appendChild(cor);
...
.corridor{display:flex;align-items:center;justify-content:center;height:38px;
  ...
  letter-spacing:.15em;text-transform:uppercase;padding:0 20px;gap:8px;}
